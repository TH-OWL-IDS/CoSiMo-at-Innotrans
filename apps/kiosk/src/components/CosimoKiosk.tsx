...
export default function CosimoKiosk({
  ...
  setup: { onSave: (url: string, layout: PanelLayout, seat: number, showcase: boolean, motion: SlitMotion, carried: boolean) => void; onCancel: () => void; onOpenTestChat: () => void } | null;
  ...
  const seat = useSeat(serverUrl, "kiosk", { nativeStt, seat: seatNumber >= 1 && seatNumber <= 4 ? seatNumber : undefined, showcase, carried });
